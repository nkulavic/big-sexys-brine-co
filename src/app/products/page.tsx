...
export const metadata: Metadata = {
  title: "The Lineup",
  description:
    "15 handcrafted varieties of bold, pickled goodness. From spicy to sweet heat, garlic obsessions to traditional escabeche — find your new favorite jar.",
  openGraph: {
    title: "The Lineup | Big Sexy's Brine Co.",
    description: "15 handcrafted varieties of bold, pickled goodness. Find your new favorite jar.",
